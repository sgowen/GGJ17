...
void GameSession::startGame()
{
	...
	for (int i = 0; i < 1; i++)
	{
        ...
        float delay = static_cast <float> (rand()) / (static_cast <float> (RAND_MAX / 54));
